...
project = 'MSL-Pipeline'
copyright = pipeline.__copyright__[1:]
...
htmlhelp_basename = 'MSL-Pipelinedoc'
...
latex_documents = [
    (master_doc, 'MSL-Pipeline.tex', 'MSL-Pipeline Documentation',
...
man_pages = [
    (master_doc, 'MSL-Pipeline', 'MSL-Pipeline Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MSL-Pipeline', 'MSL-Pipeline Documentation',
     author, 'MSL-Pipeline', 'Create a sequential pipeline.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    'python': ('https://docs.python.org/{0}.{1}'.format(*sys.version_info), None),
}
